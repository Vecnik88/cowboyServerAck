ERL_CFLAGS ?= -finline-functions -Wall -fPIC -I "/usr/lib/erlang/erts-9.2/include" -I "/usr/lib/erlang/lib/erl_interface-3.10.1/include"
ERL_LDFLAGS ?= -L "/usr/lib/erlang/lib/erl_interface-3.10.1/lib" -lerl_interface -lei
